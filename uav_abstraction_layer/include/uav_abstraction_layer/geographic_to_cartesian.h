...
inline geometry_msgs::Point32 geographic_to_cartesian (geographic_msgs::GeoPoint actual_coordinate_geo, geographic_msgs::GeoPoint origin_geo)
{
    ...
    if( int(actual_coordinate_UTM.zone)==60 && origin_UTM.zone==1 ) {         // Coordinate and origin separated by the +-180Âº longitude
    ...
    if( origin_UTM.band=='N' && actual_coordinate_UTM.band=='M' ) {         // Coordinate and origin separated by the 0Âº latitude
